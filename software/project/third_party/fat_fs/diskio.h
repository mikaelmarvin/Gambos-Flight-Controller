...
#define CTRL_SYNC                                                    \
    0 /* Complete pending write process (needed at FF_FS_READONLY == \
         0) */
#define GET_SECTOR_COUNT                                             \
    1 /* Get media size (needed at FF_USE_MKFS == 1) */
...
#define CTRL_TRIM                                                    \
    4 /* Inform device that the data on the block of sectors is no   \
