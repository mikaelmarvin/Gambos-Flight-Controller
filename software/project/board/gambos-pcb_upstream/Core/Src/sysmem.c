...
/**
 * @brief _sbrk() allocates memory to the newlib heap and is used by
 * malloc and others from the C library
 *
 * @verbatim
 * ############################################################################
 ...
 * _Min_Stack_Size #
 * ############################################################################
 * ^-- RAM start      ^-- _end                             _estack,
 * RAM end --^
 * @endverbatim
 *
 * This implementation starts allocating at the '_end' linker symbol
 * The '_Min_Stack_Size' linker symbol reserves a memory for the MSP
 * stack The implementation considers '_estack' linker symbol to be
 * RAM end NOTE: If the MSP stack, at any point during execution,
 * grows larger than the reserved size, please increase the
 * '_Min_Stack_Size'.
 *
...
void *_sbrk(ptrdiff_t incr) {
    ...
    extern uint32_t
        _Min_Stack_Size; /* Symbol defined in the linker script */
