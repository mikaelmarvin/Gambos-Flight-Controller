 ...
 *renamed to stm32f4xx_hal_conf.h.
 ******************************************************************************
 * @attention
 *
 ...
 * used in your application. This value is used by the RCC HAL module
 * to compute the system frequency (when HSE is used as system clock
 * source, directly or through the PLL).
 */
#if !defined(HSE_VALUE)
#define HSE_VALUE                                                    \
    26000000U /*!< Value of the External oscillator in Hz */
#endif        /* HSE_VALUE */

#if !defined(HSE_STARTUP_TIMEOUT)
#define HSE_STARTUP_TIMEOUT                                          \
    100U /*!< Time out for HSE start up, in ms */
#endif   /* HSE_STARTUP_TIMEOUT */

/**
 * @brief Internal High Speed oscillator (HSI) value.
 *        This value is used by the RCC HAL module to compute the
 * system frequency (when HSI is used as system clock source, directly
 * or through the PLL).
 */
#if !defined(HSI_VALUE)
#define HSI_VALUE                                                    \
    ((uint32_t)16000000U) /*!< Value of the Internal oscillator in   \
                             Hz*/
#endif                    /* HSI_VALUE */
...
#define LSE_STARTUP_TIMEOUT                                          \
    5000U /*!< Time out for LSE start up, in ms */
#endif    /* LSE_STARTUP_TIMEOUT */

/**
 * @brief External clock source for I2S peripheral
 *        This value is used by the I2S HAL module to compute the I2S
 * clock source frequency, this source is inserted directly through
 * I2S_CKIN pad.
 */
...
/* Tip: To avoid modifying this file each time you need to use
   different HSE,
...
/* PHY Reset delay these values are based on a 1 ms Systick
 * interrupt*/
